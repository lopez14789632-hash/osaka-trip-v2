...
const Tools: React.FC<ToolsProps> = ({ onSwitchTab }) => {
  return (
    <div className="px-6 py-10 space-y-8 min-w-0 font-['Zen_Maru_Gothic']" style={{ color: '#5D4037' }}>
      ...
      <section className="grid grid-cols-2 gap-4">
        ...
        <button 
          ...
          className="bg-accent text-navy border-4 border-navy p-6 rounded-[2rem] sticker-shadow flex flex-col items-center gap-3 active:translate-y-1"
          style={{ borderStyle: 'solid' }}
        >
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-white border-4 border-navy p-5 rounded-[2rem] sticker-shadow space-y-4" style={{ borderStyle: 'solid' }}>
